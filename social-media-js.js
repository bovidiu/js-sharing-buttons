...
(function(){
    ...
    SocialMedia.set={
        ...
        ATag:function(cls,txt,hrf){

            anchorLink = document.createElement('a');
            anchorText = document.createTextNode(txt);

            anchorLink.setAttribute('class', cls);
            anchorLink.setAttribute('href', hrf);
            anchorLink.appendChild(anchorText);
            parentDiv = document.getElementById(attachedParent);
            return parentDiv.appendChild(anchorLink);
        },
        PageURL:function(){
            return document.URL;
        }
